...
<body>
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
            <ul class="nav navbar-nav">
                <?php
                    ...
                    echo '<li class="nav-item"><a href="'. base_url() .'" class="nav-link">inicio</a></li>';
                    foreach($datos as $dato){
                        ...
                        foreach($paginas as $pagina2)
                            echo '<a class="dropdown-item" href="'. base_url() . '/pagina/ver/'.$pagina2['id'].'">'. $pagina2['titulo'] .'</a>';
                        echo '</div>
                    </li>';
                    }
                ?>
                    ...
                    <ul class="dropdown-menu form-wrapper">					
                        <li>
                            <form action="'. base_url() .'/registrar/guardar">
                                ...
                                <div class="form-group">
                                    <input name="contraseña" type="password" class="form-control" placeholder="Contraseña" required="required">
                                </div>
                                <div class="form-group">
                                    <input name="repetirContraseña" type="password" class="form-control" placeholder="Repetir contraseña" required="required">
                                </div>
    ...
    <div class="container">
        ...
        <div class="col-lg-8">
            ...
            <!-- Title -->
            <h1 class="mt-4"><?php echo $pagina['titulo']; ?></h1>
            <hr>

            <!-- Date/Time -->
            <p>Posteado en <?php echo $pagina['created_at']; ?></p>
            ...
            <!-- Post Content -->
            <p class="lead"><?php echo $pagina['contenido']; ?></p>
            ...
            <div class="card my-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url() . '/pagina/comentario/' . $pagina['id'] ?>">
                        <div class="form-group">
                    ...
                    <!-- Single Comment -->
                <?php   $paginas = new PaginaModel();
                        $comentarios = $paginas->getComentarios($pagina['id']);
                        foreach($comentarios as $comentario){
                            echo '<div class="media mb-4">
                                <img class="d-flex mr-3 rounded-circle" src="http://placehold.it/50x50" alt="">
                                <div class="media-body">
                                    <h5 class="mt-0">';
                                    $modelito = new UsuarioModel;
                                    $usu = $modelito->find($comentario['usuario_id']);
                            echo $usu['nombre'];    
                            echo    '</h5>
                                    <p class="small">Comentado en '.$comentario['created_at'].'</p>
